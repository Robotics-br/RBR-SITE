...
export const cases: CaseStudy[] = [
  {
    ...
    shortDescription: 'Redução de 60% nas ligações telefônicas com assistente digital para agendamento e dúvidas de pacientes.',
    category: 'sistema',
    image: '/images/portfolio/chatbot-clinica.jpg',
    client: 'Clínica Vida Plena',
    industry: 'Saúde',
    duration: '3 semanas',
    problem: 'A Clínica Vida Plena recebia mais de 200 ligações por dia para agendamentos, confirmações e dúvidas simples. A recepção ficava sobrecarregada, pacientes esperavam em fila no telefone e a equipe não conseguia focar no atendimento presencial de qualidade.',
    solution: 'Implementamos um assistente digital integrado ao WhatsApp e ao sistema de agendamento da clínica. O chatbot realiza agendamentos, confirma consultas, responde dúvidas frequentes sobre preparos para exames e envia lembretes automatizados. Para casos complexos, direciona para a recepcionista com todo o contexto da conversa.',
    results: [
  ...
  },
  {
    ...
    shortDescription: 'Ciclo de vendas reduzido pela metade com automação que gera propostas personalizadas em minutos.',
    category: 'sistema',
    image: '/images/portfolio/automacao-propostas.jpg',
    client: 'Torres Engenharia',
    industry: 'Engenharia',
    duration: '4 semanas',
    problem: 'A equipe comercial da Torres Engenharia levava em média 2 dias para montar cada proposta comercial. O processo envolvia copiar dados de planilhas, formatar documentos manualmente e aguardar aprovação de múltiplos setores. Muitos leads esfriavam durante a espera.',
    solution: 'Criamos um sistema automatizado que puxa dados do CRM, aplica templates personalizados por tipo de serviço, calcula valores baseado em parâmetros predefinidos e gera PDFs profissionais prontos para envio. O vendedor preenche um formulário rápido e em minutos tem a proposta pronta, com aprovação automática para valores dentro da alçada.',
    results: [
  ...
  },
  {
    ...
    shortDescription: 'Decisões 3x mais rápidas com dashboards que consolidam dados de vendas, marketing e operações em tempo real.',
    category: 'sistema',
    image: '/images/portfolio/dashboard-bi.jpg',
    client: 'Distribuidora Almeida',
    industry: 'Distribuição',
    duration: '5 semanas',
    problem: 'A Distribuidora Almeida tinha dados espalhados em 6 sistemas diferentes: ERP, planilhas de vendedores, controle de estoque manual, CRM, analytics do e-commerce e relatórios de entrega. A diretoria levava semanas para consolidar informações e tomar decisões estratégicas, muitas vezes baseadas em dados desatualizados.',
    solution: 'Desenvolvemos dashboards de BI que integram todas as fontes de dados em tempo real. Painéis executivos mostram KPIs de vendas, margem, giro de estoque, performance por região e vendedor, eficiência logística e ROI de marketing. Alertas automáticos notificam quando indicadores saem dos padrões esperados.',
    results: [
  ...
  },
  {
    ...
    shortDescription: 'Economia de 30h semanais com tecnologia que classifica, extrai e organiza documentos automaticamente.',
    category: 'sistema',
    image: '/images/portfolio/triagem-docs.jpg',
    client: 'PG Assessoria Contábil',
    industry: 'Contabilidade',
    duration: '4 semanas',
    problem: 'A PG Assessoria recebia centenas de documentos por semana de seus clientes: notas fiscais, comprovantes, contratos e declarações. A triagem manual consumia 30+ horas semanais da equipe, com frequentes erros de classificação que geravam retrabalho e atrasos nas obrigações fiscais.',
    solution: 'Implementamos um pipeline de automação com IA que recebe documentos por email ou upload, classifica automaticamente por tipo e cliente, extrai dados relevantes (valores, datas, CNPJ) e organiza em pastas estruturadas. Documentos com baixa confiança na classificação são direcionados para validação humana.',
    results: [
  ...
  },
  {
    ...
    shortDescription: '4 colaboradores liberados para atividades estratégicas com automação gerenciando o suporte de primeiro nível.',
    category: 'sistema',
    image: '/images/portfolio/atendimento-ia.jpg',
    client: 'TechSolutions Ltda',
    industry: 'Tecnologia',
    duration: '3 semanas',
    problem: 'A empresa recebia mais de 150 tickets de suporte por dia, a maioria com dúvidas repetitivas sobre configuração, reset de senha e status de pedidos. A equipe de 6 pessoas não dava conta, o tempo de resposta ultrapassava 24h e a satisfação do cliente estava em queda.',
    solution: 'Implementamos um sistema de atendimento em camadas: chatbot inteligente resolve dúvidas frequentes e executa ações simples (reset de senha, status de pedido); tickets complexos são encaminhados para atendentes humanos com contexto completo da conversa e sugestão de resolução gerada por IA.',
    results: [
  ...
  },
  {
    ...
    shortDescription: 'ERP, CRM e marketing conectados com workflows automatizados que eliminam retrabalho e erros manuais.',
    category: 'sistema',
    image: '/images/portfolio/integracao-ia.jpg',
    client: 'GrupoVale Distribuição',
    industry: 'Distribuição',
    duration: '6 semanas',
    problem: 'O GrupoVale operava com ERP, CRM, plataforma de marketing e controle logístico totalmente desconectados. A equipe passava horas replicando dados entre sistemas, gerando inconsistências, notas fiscais com dados errados e campanhas de marketing disparadas para clientes com pedidos em atraso.',
    solution: 'Criamos uma camada de integração que conecta todos os sistemas via APIs e webhooks. Quando um pedido é fechado no CRM, automaticamente gera pedido no ERP, atualiza o estoque, dispara comunicação ao cliente e ajusta a régua de marketing. Dashboards unificados mostram a jornada completa do cliente.',
    results: [
