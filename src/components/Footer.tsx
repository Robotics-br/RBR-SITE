        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600">
              <li><Link href="/servicos/clinicas" className="hover:text-indigo-600 transition-colors">Automação para Clínicas</Link></li>
              <li><Link href="/servicos/distribuidoras" className="hover:text-indigo-600 transition-colors">Automação para Distribuidoras</Link></li>
              <li><Link href="/servicos/escritorios" className="hover:text-indigo-600 transition-colors">Automação para Escritórios</Link></li>
              <li><Link href="/cases" className="hover:text-indigo-600 transition-colors">Cases</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600">
              ...
              <li><Link href="/equipe" className="hover:text-indigo-600 transition-colors">Equipe</Link></li>
