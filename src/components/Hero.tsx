        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 mb-12 lg:mb-0 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/contato" className="inline-flex justify-center items-center px-8 py-4 text-base font-bold rounded-full text-white bg-indigo-600 hover:bg-indigo-700 transition-all shadow-lg hover:shadow-indigo-500/30 transform hover:-translate-y-1">
