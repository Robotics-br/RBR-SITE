    ...
    <section className="py-14 border-b border-slate-100 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-start justify-items-center">
          <Metric icon={<TrendingUp size={24} />} value="47%" label="Aumento médio em produtividade" />
          <Metric icon={<Clock size={24} />} value="120h" label="Economizadas por mês em média" />
          <Metric icon={<Zap size={24} />} value="15 dias" label="Para o primeiro resultado concreto" />
          <Metric icon={<ThumbsUp size={24} />} value="98%" label="Taxa de satisfação dos clientes" />
        </div>
      </div>
    </section>
  );
