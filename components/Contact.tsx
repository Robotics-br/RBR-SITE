            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        Conte-nos sobre seu projeto e receba um diagnóstico personalizado. Sem compromisso, sem letra miúda — apenas uma conversa sobre como podemos acelerar seus resultados.
                    </p>
                </div>
